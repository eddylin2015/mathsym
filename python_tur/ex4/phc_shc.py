...
import re
#init parameters
home_url=cfg.myshc_home_url
circular_url=cfg.myshc_circular_url
circular_title=cfg.myshc_circular_title
form_url=cfg.myshc_form_url
UserLogin=cfg.myshc_UserLogin
UserPassword=cfg.myshc_UserPassword
#init browser
options = Options()
...
for li in links:
    if li.text== circular_title % today_date:
        ...
        if "Signed"  in browser.find_element_by_class_name('form_table_v30').text:
            pass
        else:
